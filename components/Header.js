  ...
  return (
    <div className="fixed top-12 z-20 flex ">
      ...
      <div className="fixed right-5 flex flex-row items-center justify-end space-x-3 ">
        <button
          className="m-auto ml-4 mt-5 flex flex-row items-center justify-center rounded-xl bg-white/100 p-2.5 text-primary   duration-300 ease-linear hover:bg-primary hover:text-white "
          onClick={() => {}}
        >
          <FilterIcon className="h-5 w-5" />
        </button>
        <button
          className="m-auto mt-5 flex flex-row items-center justify-center rounded-xl bg-white/100 p-2.5 text-primary   duration-300 ease-linear hover:bg-primary hover:text-white "
          onClick={() => {}}
        >
