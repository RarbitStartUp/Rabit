...
export default function Card({
  ...
  return (
    <div className=" mt-3 flex h-[30rem] w-[20.5rem] grid-cols-2 flex-col rounded-2xl bg-white p-4 shadow-lg duration-300 ease-linear dark:bg-slate-800 dark:shadow-slate-700 sm:w-full md:h-[20.5rem] md:w-[50rem] md:flex-row-reverse">
