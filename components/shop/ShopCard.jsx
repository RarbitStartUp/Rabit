...
export default function ShopCard({
  ...
  return (
    <div className=" mt-3 h-[28rem] w-screen flex-col rounded-2xl bg-white pr-2 pl-2 shadow-lg duration-300 ease-linear dark:bg-slate-800 dark:shadow-slate-700 md:h-[28rem] md:w-[25rem] md:rounded-2xl ">
